...
.project-item { display: flex; align-items: center; gap: 3rem; background: #fff; border-radius: 16px; padding: 2rem; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.08); transition: all 0.3s ease; }
...
.project-image { flex: 0 0 300px; height: 250px; border-radius: 12px; overflow: hidden; background: #efd1bd; display: flex; align-items: center; justify-content: center; }
.project-image img { width: 100%; height: 100%; object-fit: cover; }
.project-image-placeholder { width: 100%; height: 100%; background: linear-gradient(135deg, #efd1bd 0%, #e0d9bf 100%); display: flex; align-items: center; justify-content: center; color: #918a6f; font-size: 1.2rem; text-align: center; }
.project-content { flex: 1; }
.project-card-icon { width: 60px; height: 60px; background: #efd1bd; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-bottom: 1.5rem; color: #918a6f; }
.project-card-title { font-size: 1.8rem; color: #2d373f; margin: 0 0 0.5rem; font-weight: bold; line-height: 1.3; }
.project-card-subtitle { font-size: 1.1rem; color: #918a6f; margin: 0 0 1.5rem; font-weight: 500; font-style: italic; }
.project-card-description { color: #7a8187; line-height: 1.7; margin-bottom: 1.5rem; font-size: 1.05rem; text-align: justify; text-justify: inter-word; }
.project-card-features { list-style: none; padding: 0; margin: 0 0 1.5rem 0; }
.project-card-features li { padding: 0.5rem 0; color: #4a5258; position: relative; padding-left: 1.8rem; font-size: 1rem; line-height: 1.4; }
.project-card-features li:before { content: "✓"; position: absolute; left: 0; color: #918a6f; font-weight: bold; font-size: 1rem; }
